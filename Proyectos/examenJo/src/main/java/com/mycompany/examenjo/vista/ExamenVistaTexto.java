...
public class ExamenVistaTexto implements InterfazVista {
    ...
    private void procesaNuevaOperacion() {
        ...
        switch (operacion) {
            ...
            case 1 ->
                controlador.actionPerformed(new ActionEvent(this, operacion, CREARCRPETAS));
            case 2 ->
                controlador.actionPerformed(new ActionEvent(this, operacion, ALTADATOSCARRERASUNIVERSITARIAS));
            case 3 ->
                controlador.actionPerformed(new ActionEvent(this, operacion, GENERARARCHIVOXML));
            case 4 ->
                controlador.actionPerformed(new ActionEvent(this, operacion, GENERARPLANTILLAXSL));
            case 5 ->
                controlador.actionPerformed(new ActionEvent(this, operacion, MODIFICARCARRERA));
            case 6 ->
                controlador.actionPerformed(new ActionEvent(this, operacion, GENERARPAGINAWEB));
