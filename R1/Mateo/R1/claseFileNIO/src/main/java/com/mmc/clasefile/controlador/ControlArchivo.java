        ...
        switch (evento.getActionCommand()){
            ...
            case InterfazVista.MOSTRARCONTENIDO -> {
                ...
                */
                ...
                modelo.mostrarContenido(directorioPadre);
            ...
            case InterfazVista.RENOMBRAR -> {
                ...
                modelo.renombrarArchivo(directorioPadre, nuevoNombre);
            ...
            case InterfazVista.ELIMINAR -> {
                ...
                modelo.eliminar(directorioPadre,nombre);
            ...
            case InterfazVista.CREARARCHIVO -> {
                ...
                modelo.crearArchivo(directorioPadre, nombre);
